...
<div class="container">
    ...
    <div class="row">
        ...
        <a href="#" data-toggle="modal" data-typeid="" data-target=".add_modal"
                    ...
                    </a><a href="#" data-toggle="modal" data-typeid="" data-target=".import_excel"
                       class="btn btn-info btn-sm" data-id="" style="float: right; margin-right: 5px;">
                        ...
                        <div class="form-group row " style="margin-bottom: 0px;">
                            ...
                            <div class="col-md-2" style="padding-left: 0px;">
                                <button class="btn btn-success btn-sm searchdata"
                                        style="margin-top: 33px;">Search <span
                                        class="spinner"></span>
                                </button>
                                <a href="{{ route('company.employee.index') }}" class="btn btn-danger btn-sm"
    ...
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            ...
            <div class="modal-body">
                 <form  autocorrect="off" action="{{ route('company.holiday.importexcel') }}" autocomplete="off" method="post" class="form-horizontal form-bordered importexcel">
                    {{ csrf_field() }}
...
@push('script')
    ...
    <script src="{{ URL::asset('public/admin/plugins/bs-custom-file-input/bs-custom-file-input.min.js') }}"></script>
    <script>
        ...
        $(function () {
            ...
            $("#employee").DataTable({
                ...
                stateSave: true,
                ajax: {
                    'url': "{{ route('company.holiday.getall') }}",
                    'type': 'POST',
                    'data': function (d) {
                        d._token = "{{ csrf_token() }}";
                        d.status = $("#status").val();
        ...
        $('body').on('click', '.openaddmodal', function () {
            ...
            $.ajax({
                url: "{{ route('company.holiday.getmodal')}}",
                type: 'POST',
                headers: {
        ...
        $('body').on('click', '.changestatus', function () {
            ...
            (new PNotify({
                ...
                $.ajax({
                    url: '{{ route("company.holiday.changestatus") }}',
                    type: 'POST',
                    headers: {
                        'X-CSRF-TOKEN': '{{ csrf_token() }}'
                    },
