            ...
            <ul class="navbar-nav">
              ...
              <!--   <li class="nav-item">
                    <a href="{{ route('admin.demo') }}"
                        class="nav-link {{activeMenu('demo')}}">{{ __('message.Demo') }}</a>
                </li> -->
                ...
                @endif
                @if(checkPermission(['super_admin','user']))
                <li class="nav-item">
                    <a href="{{ route('admin.clients.index')}}" class="nav-link {{activeMenu('clients')}}">Clients</a>
                </li>
                @if(checkPermission(['super_admin','user']))
                <li class="nav-item">
                    <a href="{{ route('admin.group.index')}}" class="nav-link {{activeMenu('group')}}"> Groups</a>
                </li>
                @endif
                @if(checkPermission(['operator','super_admin','user']))
                <li class="nav-item">
                    <a href="{{ route('admin.works.index')}}" class="nav-link {{activeMenu('works')}}">Works</a>
                </li>
                @endif
                @endif
                @if(checkPermission(['operator','super_admin','user']))
                <li class="nav-item">
                    <a href="{{ route('admin.todos.index')}}" class="nav-link {{activeMenu('todos')}}">To Do</a>
                </li>
                @endif
                @if(checkPermission(['super_admin']))
                <li class="nav-item">
                    <a href="{{ route('admin.premiumreport.index')}}" class="nav-link {{activeMenu('premiumreport')}}">Premium Report</a>
                </li>
                @endif
                @if(checkPermission(['super_admin']))
                <!-- <li class="nav-item">
                    <a href="{{ route('admin.report.index')}}" class="nav-link {{activeMenu('report')}}"> Report</a>
                </li> -->
                @endif
