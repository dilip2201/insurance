<form  autocorrect="off" action="{{ route('admin.premiumreport.storelog') }}" autocomplete="off" method="post" class="form-horizontal form-bordered formsubmitlog">
   {{ csrf_field() }}

   <div class="row">
    <input type="hidden" name="user_id" value="{{ $user_id }}">
    <input type="hidden" name="premium_report_id" value="{{ $premium_report_id }}">
